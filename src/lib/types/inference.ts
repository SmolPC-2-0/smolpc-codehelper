/**
 * TypeScript types for shared-engine inference payloads surfaced through Tauri.
 * These should match the JSON contract exposed by the engine host and app commands.
 */
