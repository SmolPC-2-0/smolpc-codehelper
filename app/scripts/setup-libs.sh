...
# Keep the native GenAI package aligned with the current supported DML export line.
# NuGet 0.12.2 still depends on Microsoft.ML.OnnxRuntime.DirectML 1.23.0.
GENAI_DML_PACKAGE_VERSION="0.12.2"
...
SHA_GENAI_DML_NUPKG="3a28d89bc9140b8349fcee7e4ce1589f800418acd29c3975126a84262fd7e0cf"
