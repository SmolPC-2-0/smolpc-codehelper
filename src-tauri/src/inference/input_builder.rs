...
impl InputBuilder {
    ...
    pub fn new() -> Self {
        ...
        // Pre-size HashMap: 2 base inputs + 28 layers * 2 (key + value)
        let capacity = 2 + NUM_LAYERS * 2;

        Self {
            input_ids_key: "input_ids".to_string(),
            attention_mask_key: "attention_mask".to_string(),
            past_key_names,
            past_value_names,
