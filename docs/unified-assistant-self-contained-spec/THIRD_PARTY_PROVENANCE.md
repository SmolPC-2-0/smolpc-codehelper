...
| LibreOffice MCP runtime scripts                | imported from `origin/codex/libreoffice-port-track-a` @ `7acad1fa0eb31e32a5485069e85c021d14284455` | pinned         | pending explicit license note | already present in unified resources      | Phase 3 switches them onto bundled Python ownership |
...
| Default bundled model `qwen3-4b-instruct-2507` | current engine-supported model artifact source                                                     | pending        | pending                       | not yet bundled                           | Phase 2 foundation import                           |
