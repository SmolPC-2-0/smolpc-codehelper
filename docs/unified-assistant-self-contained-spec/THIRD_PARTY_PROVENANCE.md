...
| Bundled Python runtime                         | packaging-side managed runtime plus wheels                                                         | pending        | pending                                                           | manifest/staging contract landed          | Phase 2 added manifests and staging hooks; final packaged payload is still pending              |
