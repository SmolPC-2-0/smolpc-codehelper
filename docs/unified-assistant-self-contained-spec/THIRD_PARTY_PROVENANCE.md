...
**Status:** Required tracker with Phase 3 bundled-Python source contract locked for LibreOffice, Phase 4 Blender addon repackaged, and Phase 5 GIMP provenance preflight merged; exact GIMP import pin still pending
...
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------- | ----------------------------------------------------------------- | ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GIMP MCP/plugin runtime                        | upstream `maorcc/gimp-mcp` default branch `main` observed on 2026-03-21 at `fb3c6c6a6aa9b4e260a52d277ea3e7bd8330133c` (exact import pin still required before vendoring) | preflight lock | pending                                                           | not yet imported into self-contained line | Phase 5 preflight is merged on the self-contained mainline; the implementation branch must replace this observed reference with the exact vendored revision, license note, and file import map before payload files are imported |
